...
function Footer(props) {
  return (
    <Grid container direction="row" style={{marginBottom: "3rem"}}>
      <Grid container item xs={6} md={3} direction="column" className="mobileinvisible">
        <div className="links">
          <Grid container item>
            <body1>
      ...
      <Grid containter item direction="column" xs={12} md={6}>
        <Grid container item>
      ...
      <Grid container item xs={8} md={3} justify="flex-end" >
        <Link href="/">
